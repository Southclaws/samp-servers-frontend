...
export default class Clients extends Component<ClientsProps, ClientsState> {
    constructor(props: ClientsProps) {
        super(props);
        let clientButtonText = ["SA:MP Client Not Good Enough?", "Try a Modern SA:MP Client Today", "Are You Still Using The Default Client?"];
            ...
            >
                ...
                <Modal.Content image>
                    ...
                    <Modal.Description>
                        ...
                        <Container text>
                            This application allows you to view a vast amount of SA-MP servers, filter them, save them as your favourites and play on them. You
                            won't loose your original favourites, since those will be taken over. Also it includes a SA-MP version changer, access to SA-MP
                            legacy settings, screenshots and chatlogs.
                        </Container>
                        <Divider />
                        <a target="_blank" href="https://github.com/Bios-Marcel/ServerBrowser/releases/">
